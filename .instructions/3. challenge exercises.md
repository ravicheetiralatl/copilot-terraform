...
-  Run the formatting and Linting for the all the terraform files 
-  Change the size of AWS EC2 instance to t2.large
-   Add more tags like cost center,environment to all the resources
-   Change the OS of the AWS EC2
...
<details>
<summary>Challenge #3 - Creating a new terraform resources</summary>

### Creating a new terraform file
- Try creating a new AWS VPC with the natural text
